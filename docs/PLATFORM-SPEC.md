...
| Assistant | Cross-platform query and action layer | conversation, citation, proposed action |
...
One assistant operates across modules. It should retrieve scoped records, cite the records it used and propose actions before writing.
